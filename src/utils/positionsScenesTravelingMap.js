export const positionsScenesTravelingMap = {
  ...
  TreeHouse: {
    ...
    positionSpawnInScene :{x: 720, y:700},
    name: "Casa del árbol",
  ...
  Lake: {
    ...
    x: 805, 
    y: 250,
    spawnPosition :{x: 805, y: 350},
    positionSpawnInScene :{x: 100, y:100},
  ...
  BubblegumLab: {
    ...
    positionSpawnInScene :{x: 700, y:150},
    name: "Chuchelandia",
  ...
  TrompiHouse: {
    ...
    positionSpawnInScene :{x: 800, y:300},
  ...
  Cube: {
    ...
    positionSpawnInScene :{x: 900, y:300},
